...
import { XIcon, FolderPlusIcon, Loader2Icon } from "lucide-react";
...
export default function NewFolderDialog({ open, onClose, onConfirm }: Props) {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            >
              {loading ? <Loader2Icon className="w-4 h-4 animate-spin" /> : "Create"}
            </button>
          </div>
        </form>
      </div>
